...
/**
 * ClassRollSubmissionGrader.java
 ...
 * @version 2017-09-07
 */
public class ClassRollSubmissionGrader {

    // private static final int MAX_STYLE_POINTS = 10;
    private static final int MAX_CORRECTNESS_POINTS = 50;
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Result result = JUnitCore.runClasses(ClassRollTest.class);
